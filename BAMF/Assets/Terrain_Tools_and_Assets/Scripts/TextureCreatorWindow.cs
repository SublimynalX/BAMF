...
public class TextureCreatorWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        perlinXScale = EditorGUILayout.Slider("XScale", perlinXScale, 0, 0.1f);
        perlinYScale = EditorGUILayout.Slider("YScale", perlinYScale, 0, 0.1f);
        ...
        seamlesToggle = EditorGUILayout.Toggle("Seamless?", seamlesToggle);
